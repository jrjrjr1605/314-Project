...
export default function PINCompletedRequests() {
  ...
  const get_pin_requests_completed = async () => {
    setLoading(true)
    setError(null)
    try {
  ...
  const search_pin_requests_completed = async () => {
    setLoading(true)
    setError(null)
    try {
      const body = {
          ...
          <div>
            ...
            <div className="flex flex-wrap items-end gap-4">
              ...
              <div className="pt-5 flex gap-2">
                <Button onClick={search_pin_requests_completed} disabled={loading}>
